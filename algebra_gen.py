...
class WordProblem:
    def __init__(self):
        ...
        bank.add((
                 'John has a farm with pigs and chickens. If he looks out and counts 34 heads and 72 tails, how many pigs does he have?',
                 2, '', 'pigs', ''))
        bank.add((
                 'John has a farm with pigs and chickens. If he looks out and counts 16 heads and 40 tails, how many chickens does he have?',
                 12, '', 'chickens', ''))
        bank.add((
                 'John has a farm with pigs and chickens. If he looks out and counts 87 heads and 252 tails, how many pigs does he have?',
                 39, '', 'pigs', ''))
        bank.add((
                 'John has a farm with pigs and chickens. If he looks out and counts 54 heads and 150 tails, how many chickens does he have?',
                 33, '', 'chickens', ''))

        bank.add(
            ('Alicia has 23 coins, all nickels or dimes, totaling to $1.75.  How many dimes does she have? 12 dimes',
             12, '', 'dimes', ''))
        ...
        bank.add(
            ('i have a 20 oz jar containing a solution of 30% acid and a 12 oz jar containing a solution of 10% acid.  '
             'I pour them both into a 40 oz jar, then top it off with acid.  '
             'What percentage of the 40 oz jar is filled with acid?', 38, '', '$\%$', ''))

        # age
        bank.add((
                 'The sum of the ages of Billy\'s seven children is 34.  What will the sum of their ages be in 10 years?',
                 104, '', 'years', ''))
        bank.add((
                 'Ken is two years older than Eric.  Half of Eric\'s age minus 3 is equal to one third Ken\'s age.  How old is Ken?',
                 24, '', 'years old', ''))
        ...
        # faucets
        bank.add((
                 'A bathtub has three faucets - A, B and C - which can fill the tub alone in 1,3, and 6 hours respectively.  '
                 'If all 3 faucets are on, how many minutes will it take to fill the tub?', 40, '', 'minutes', ''))

        # driving
        bank.add((
                 'John drives 252 miles to LA in 5 hours and 298 miles back in 6.  What is his average speed for the entire trip?',
                 50, '', 'mph', ''))
        bank.add((
                 'John drives to LA at a speed of 56 mph and back at a speed of 42 mph, what is his average speed?', 48,
                 '', 'mph', ''))
...
class Counting:
    def __init__(self):
        ...
        bank.add((
                 'There are 4 people in a room.  If everyone shakes hands with every other person in the room once, how any handshakes occur? ',
                 6, '', ''))
        bank.add((
                 'There are 6 people in a room.  If everyone shakes hands with every other person in the room once, how any handshakes occur? ',
                 15, '', ''))
        bank.add((
                 'There are 7 people in a room.  If everyone shakes hands with every other person in the room once, how any handshakes occur? ',
                 21, '', ''))
        ...
        bank.add((
                 'In a six team round robin tournament each team plays each other team twice. How many games are played?',
                 30, '', ''))
        ...
        bank.add((
                 'John is walking directly from home to school.  He needs to go 4 blocks North and 4 blocks West.  How many different ways can he do this?',
                 70, '', ''))
        bank.add((
                 'Jane is walking directly home from the gym.  She needs to go 4 blocks North and 2 blocks West.  How many different ways can she do this?',
                 15, '', ''))
