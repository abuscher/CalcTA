...
def main():
    ...
    if type1 == 0 and type2 == 0:
        ...
        poly['x^e'] = ['e*x^(e-1)',
                       'Use the <a class="hintlink" href="http://www.calcta.com/tutorial.php?page=derivative/basicrules&page_id=1"  target="_blank">Power rule</a> for derivatives.']
        # fraction
        poly['x^(1/2)'] = ['1/2*x^(-1/2)',
                           'Use the <a class="hintlink" href="http://www.calcta.com/tutorial.php?page=derivative/basicrules&page_id=1"  target="_blank">Power rule</a> for derivatives.']
        poly['x^(1/3)'] = ['1/3*x^(-2/3)',
                           'Use the <a class="hintlink" href="http://www.calcta.com/tutorial.php?page=derivative/basicrules&page_id=1"  target="_blank">Power rule</a> for derivatives.']
        poly['x^(7/3)'] = ['7/3*x^(4/3)',
                           'Use the <a class="hintlink" href="http://www.calcta.com/tutorial.php?page=derivative/basicrules&page_id=1"  target="_blank">Power rule</a> for derivatives.']
        poly['x^(-1/2)'] = ['-1/2*x^(-3/2)',
                            'Use the <a class="hintlink" href="http://www.calcta.com/tutorial.php?page=derivative/basicrules&page_id=1"  target="_blank">Power rule</a> for derivatives.']
        poly['x^(-1/3)'] = ['-1/3*x^(-4/3)',
                            'Use the <a class="hintlink" href="http://www.calcta.com/tutorial.php?page=derivative/basicrules&page_id=1"  target="_blank">Power rule</a> for derivatives.']
        # 1/over
        poly['1/x'] = ['-1/x^2',
                       'Use the <a class="hintlink" href="http://www.calcta.com/tutorial.php?page=derivative/basicrules&page_id=1"  target="_blank">Power rule</a> for derivatives.']
        ...
        poly['x^.1'] = ['.1*x^(-.9)',
                        'Use the <a class="hintlink" href="http://www.calcta.com/tutorial.php?page=derivative/basicrules&page_id=1"  target="_blank">Power rule</a> for derivatives.']
        # combination
        poly['x^3+x^(1/3)'] = ['3*x^2+1/3*x^(-2/3)',
                               'Use the <a class="hintlink" href="http://www.calcta.com/tutorial.php?page=derivative/basicrules&page_id=1"  target="_blank">Power rule</a> for derivatives.']
        poly['x+1/x'] = ['1-1/x^2',
                         'Use the <a class="hintlink" href="http://www.calcta.com/tutorial.php?page=derivative/basicrules&page_id=1"  target="_blank">Power rule</a> for derivatives.']
        poly['x^2+2*x+1'] = ['2*x+2',
                             'Use the <a class="hintlink" href="http://www.calcta.com/tutorial.php?page=derivative/basicrules&page_id=1"  target="_blank">Power rule</a> for derivatives.']
    ...
    if type1 == 2 and type2 == 2:
        ...
        quotient['\displaystyle\\frac{ln(x^3+1)}{ln(3*x)}'] = ['((3*x^2*ln(3*x))/(x^3 - 1) - ln(x^3 - 1)/x)',
                                                               '(ln(3*x)^2)', '']
    ...
    if type1 == 0 and type2 == 2:
        ...
        quotient['\displaystyle\\frac{7*x^4 + x^3 - 3}{x^2 - 1}'] = [
            '(x^2 - 1)*(28*x^3 + 3*x^2) - 2*x*(7*x^4 + x^3 - 3)', '(x^2 - 1)^2', '']
        ...
        quotient['\displaystyle\\frac{x^4 + 2*x + 1}{1 - x^3}'] = ['3*x^2*(x^4 + 2*x + 1) - (x^3 - 1)*(4*x^3 + 2)',
                                                                   '(x^3 - 1)^2', '']
    ...
    if type1 == 1 and type2 == 2:
        ...
        quotient['\displaystyle\\frac{tan(x)}{sin(x) - cos(x)}'] = [
            '- tan(x)*(cos(x) + sin(x)) - (cos(x) - sin(x))*(tan(x)^2 + 1)', '(cos(x) - sin(x))^2', '']
    ...
    if options[0] == '1' and options[1] == '1' and type2 == 2:
        ...
        quotient['\displaystyle\\frac{x + sin(x)}{x^2 - 1}'] = ['(x^2 - 1)*(cos(x) + 1) - 2*x*(x + sin(x))',
                                                                '(x^2 - 1)^2', '']
        quotient['\displaystyle\\frac{x - cos(x)}{x^2 + x}'] = ['(sin(x) + 1)*(x^2 + x) - (x - cos(x))*(2*x + 1)',
                                                                '(x^2 + x)^2', '']
    ...
    if options[1] == '1' and options[2] == '1' and type2 == 2:
        ...
        quotient['\displaystyle\\frac{sin(x) + tan(x)}{e^x+ln(x)}'] = [
            '(e^x + ln(x))*(sec(x)^2 + cos(x))-(e^x + 1/x)*(sin(x)+tan(x))', '(e^x + ln(x))^2', '']
        quotient['\displaystyle\\frac{ln(x)}{cos(x)}'] = ['cos(x)/x + ln(x)*sin(x)', 'cos(x)^2', '']

        quotient['\displaystyle\\frac{cos(x) + e^(x)}{ln(x)}'] = ['ln(x)*(e^(x) - sin(x)) - (cos(x) + e^(x))/x',
                                                                  'ln(x)^2', '']
    ...
    if options[0] == '1' and options[2] == '1' and type2 == 2:
        ...
        quotient['\displaystyle\\frac{ln(x)}{e^(x) + ln(x)}'] = ['(e^(x) + ln(x))/x - ln(x)*(e^(x) + 1/x)',
                                                                 '(e^(x) + ln(x))^2', '']
